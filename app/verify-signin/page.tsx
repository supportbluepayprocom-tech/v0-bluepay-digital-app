...
export default function VerifySigninPage() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      // Clear signin email from session
    ...
    <div className="min-h-screen bg-[#0000ff] flex flex-col items-center justify-center px-3 py-6 sm:px-4 sm:py-8">
      <div className="w-full max-w-md flex flex-col">
        ...
        <p className="text-white text-center text-xs sm:text-sm mb-5 sm:mb-8 leading-relaxed">
          ...
          <span className="font-bold break-all">{email}</span>. Enter the code to sign in to your BLUEPAY PRO V30 account.
        </p>
        ...
        <div className="bg-[#0000ff] bg-opacity-40 backdrop-blur-md border border-white border-opacity-20 rounded-2xl sm:rounded-3xl p-4 sm:p-8 mb-4 sm:mb-8">
          ...
          <button
            ...
            className="w-full bg-white text-[#0000ff] font-bold text-sm sm:text-lg py-2 sm:py-3 rounded-lg sm:rounded-2xl hover:bg-gray-50 disabled:opacity-70 disabled:cursor-not-allowed transition-all mb-4 sm:mb-6"
          >
        ...
        {success && (
          <div className="mb-4 bg-green-500 bg-opacity-20 border border-green-400 rounded-lg p-3 flex items-start gap-2">
            ...
            <p className="text-green-200 text-xs sm:text-sm">Signed in successfully! Redirecting...</p>
          </div>
        )}
